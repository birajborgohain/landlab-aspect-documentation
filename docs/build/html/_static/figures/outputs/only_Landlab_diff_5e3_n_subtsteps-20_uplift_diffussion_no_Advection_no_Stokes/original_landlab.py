...
#========================
        ...
        # # VTK OUTPUT
        # # =====================================================
        # vtk_filename = f"landlab_{self.timestep:04d}.vtk"
        # vtk_path = os.path.join(self.output_dir, vtk_filename)

        # print(f"[Python] Writing VTK: {vtk_path}")
        ...
        # self.vtk_files.append((self.current_time, vtk_filename))

        # series_path = os.path.join(self.output_dir, "landlab.vtk.series")
        ...
        #         "files": [
        #             {"name": fname, "time": t}
        #             for t, fname in self.vtk_files
        #         ]
        #     }, f, indent=2)

        # print(f"[Python] Updated series file: {series_path}")

        # =====================================================
        # FORCE OUTPUT (correct fix)
        # =====================================================
        # if self.timestep % 1 == 0:
        #     output_directory = os.getcwd()  # or pass explicitly if needed
        ...
        #     print(f"[Landlab] Writing VTK: {filename}")
