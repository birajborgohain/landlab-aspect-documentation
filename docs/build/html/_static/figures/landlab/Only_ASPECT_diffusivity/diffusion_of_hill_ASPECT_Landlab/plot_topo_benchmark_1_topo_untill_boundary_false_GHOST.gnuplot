...
set output 'Topography_benchmark_1_topo_until_boundary_false_GHOST.png'
...
set title 'Benchmark 1: Surface Topography Evolution (Coupled ASPECT-Landlab with D = 0.25) boundary False GHOST' font ",26"
...
stats 'outputs/1_sine_zero_flux_topo_until_D_0.25_set_closed_boundaries_at_grid_edges_False_GHOST/topography.00060' \
    using (abs($3-$4)) nooutput
mad60 = STATS_mean

stats 'outputs/1_sine_zero_flux_topo_until_D_0.25_set_closed_boundaries_at_grid_edges_False_GHOST/topography.00120' \
    using (abs($3-$4)) nooutput
mad120 = STATS_mean

stats 'outputs/1_sine_zero_flux_topo_until_D_0.25_set_closed_boundaries_at_grid_edges_False_GHOST/topography.00180' \
    using (abs($3-$4)) nooutput
mad180 = STATS_mean
...
plot \
'outputs/1_sine_zero_flux_topo_until_D_0.25_set_closed_boundaries_at_grid_edges_False_GHOST/topography.00060' \
    u 1:3 w lp ls 1  t 'ASPECT t=60', \
\
'outputs/1_sine_zero_flux_topo_until_D_0.25_set_closed_boundaries_at_grid_edges_False_GHOST/topography.00060' \
    u 1:4 w l  ls 11 t 'Analytical t=60', \
\
'outputs/1_sine_zero_flux_topo_until_D_0.25_set_closed_boundaries_at_grid_edges_False_GHOST/topography.00120' \
    u 1:3 w lp ls 2  t 'ASPECT t=120', \
\
'outputs/1_sine_zero_flux_topo_until_D_0.25_set_closed_boundaries_at_grid_edges_False_GHOST/topography.00120' \
    u 1:4 w l  ls 12 t 'Analytical t=120', \
\
'outputs/1_sine_zero_flux_topo_until_D_0.25_set_closed_boundaries_at_grid_edges_False_GHOST/topography.00180' \
