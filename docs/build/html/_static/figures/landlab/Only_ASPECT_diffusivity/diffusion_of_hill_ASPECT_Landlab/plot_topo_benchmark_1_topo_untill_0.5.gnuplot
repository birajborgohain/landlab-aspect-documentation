...
set output 'Topography_benchmark_1_topo_until_D_0.5.png'
...
set title 'Benchmark 1: Surface Topography Evolution (Coupled ASPECT-Landlab with D= 0.5 )' font ",26"
...
# -----------------------------------------------------------------------------
plot \
'outputs/1_sine_zero_flux_topo_until_D_0.5/topography.00060' \
    u 1:3 w lp ls 1  t 'ASPECT t=60', \
\
'outputs/1_sine_zero_flux_topo_until_D_0.5/topography.00060' \
    u 1:4 w l  ls 11 t 'Analytical t=60', \
\
'outputs/1_sine_zero_flux_topo_until_D_0.5/topography.00120' \
    u 1:3 w lp ls 2  t 'ASPECT t=120', \
\
'outputs/1_sine_zero_flux_topo_until_D_0.5/topography.00120' \
    u 1:4 w l  ls 12 t 'Analytical t=120', \
\
'outputs/1_sine_zero_flux_topo_until_D_0.5/topography.00180' \
