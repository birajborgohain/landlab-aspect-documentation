...
# --------- Start of Map vertical_velocity to core nodes ----------------
...
# --------- End of Map vertical_velocity to core nodes ----------------
        ...
        if dt > 0:
            ...
            for _ in range(n_substeps):
                ...
                # self.uplift_rate = vertical_velocity
    ...
    def set_mesh_information(self, grid_dictionary):
        ...
        # self.uplift_rate = np.zeros(len(self.model_grid.at_node))
