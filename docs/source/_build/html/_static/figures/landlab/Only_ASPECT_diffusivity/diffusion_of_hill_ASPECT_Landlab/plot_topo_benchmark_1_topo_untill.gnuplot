...
set output 'Topography_benchmark_1_topo_until.png'
...
set title 'Benchmark 1: Surface Topography Evolution (Coupled ASPECT-Landlab with D = 0.25)' font ",26"
...
stats 'outputs/1_sine_zero_flux_topo_until/topography.00060' \
    using (abs($3-$4)) nooutput
mad60 = STATS_mean

stats 'outputs/1_sine_zero_flux_topo_until/topography.00120' \
    using (abs($3-$4)) nooutput
mad120 = STATS_mean

stats 'outputs/1_sine_zero_flux_topo_until/topography.00180' \
    using (abs($3-$4)) nooutput
mad180 = STATS_mean
